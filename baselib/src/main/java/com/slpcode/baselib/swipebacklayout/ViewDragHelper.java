...
package com.slpcode.baselib.swipebacklayout;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.slpcode.baselib.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.slpcode.baselib.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.slpcode.baselib.swipebacklayout.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.slpcode.baselib.swipebacklayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
